    ...
    return Scaffold(
      body: Column(
        children: [
          Container(
            ...
            child: Stack(
              ...
              children: [
                ...
                Text("Consulta la información de tus mascotas",
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 20,
          ...
          FilledButton(
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (x) => mascotas_crear_editar()));
              },
              child: Row(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.pets, color: Colors.blueAccent, size: 30),
                                  SizedBox(width: 10),
                                  Text(mascota['nombre']!,
                                    style: TextStyle(
                                      fontSize: 22,
                                    ...
                                    PopupMenuItem(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          SizedBox(width: 8,),
                                          Text("Eliminar", style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold))
                                        ],
                                      ),
                                    ),
                                  ];
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton.icon(
                                  onPressed: () {},
                                  icon: Icon(Icons.add, color: Colors.white, fontWeight: FontWeight.bold,),
                                  label: Text("Agendar",
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold
